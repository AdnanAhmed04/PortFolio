...
const Creative = ({ heading, para, img, index = 0 }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -8 }}
      className="group relative bg-gradient-to-br from-slate-900/90 to-slate-800/50 backdrop-blur-xl rounded-2xl p-5 md:p-6 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-500 overflow-hidden"
    >
      ...
      <div className="relative z-10">
        ...
        <motion.div
          ...
          className="w-12 h-12 mb-4 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 flex items-center justify-center text-3xl group-hover:shadow-lg group-hover:shadow-cyan-500/20 transition-all duration-300"
        >
        ...
        {/* Decorative Line */}
        <div className="mt-4 h-1 w-10 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 group-hover:w-16 transition-all duration-500" />
      </div>
