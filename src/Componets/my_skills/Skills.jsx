...
const skillsData = [
  ...
  },
  {
    category: "Back End",
    color: "text-blue-400",
    icon: <GrCloudComputer className="text-3xl" />,
    skills: [
  ...
  return (
    ...
    >
      ...
      <div className="relative text-center mb-12">
        <h2 className="text-4xl font-bold tracking-wide mb-3 text-white flex items-center justify-center">
      ...
      <div className="relative text-center mt-12">
        <a
          ...
          className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold shadow-md transition-all transform hover:scale-105"
        >
          See My Work
        </a>
      </div>
